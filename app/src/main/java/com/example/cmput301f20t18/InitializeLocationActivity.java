...
public class InitializeLocationActivity extends AppCompatActivity {
    RecyclerView recyclerView;
    Query query;
    FirestoreInitalizeLocation adapter;
    Button addLocation;
    int bookID;
    int t_id;
    ...
    public void setUp() {
        ...
        adapter = new FirestoreInitalizeLocation(options, bookID, InitializeLocationActivity.this, t_id);
