...
public class User {
    ...
    public User(String username, int appID, String DB_id, String email, String address) {
        ...
        this.owner_transactions = new ArrayList<Transaction>();
        this.borrower_transactions = new ArrayList<Transaction>();
        this.owner_book_id = new ArrayList<Integer>();
        this.borrower_book_id = new ArrayList<Integer>();
        this.owner_books = new ArrayList<Book>();
        this.borrower_books = new ArrayList<Book>();
    }
    ...
    public void ownerAcceptRequest(RequestTransaction request) {
        ...
        for (int i = 0; i < owner_transactions.size(); i++) {
            ...
            if (owner_transactions.get(i).getBookID() == bookID && owner_transactions.get(i).getStatus() == "requested") {
                ...
                // TODO remove transactions from transaction DB with same bookID and requested status
                return;
            }
        }
    }
